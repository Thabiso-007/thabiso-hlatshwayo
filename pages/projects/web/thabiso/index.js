    ...
    <div>
        ...
        <div className={'max-w-[1240px mx-auto p-10 pt-20'}>
          <div className={'col-span-4'}>
            ...
            <p className={'mt-2'}>
              I have created a straightforward website that serves as a platform for me to discuss 
              my achievements, exhibit my abilities, and showcase the projects I have completed.
            </p>
            <div className={'mt-10'}>
              <Link Link 
